...
function initialize(id) {
  ...
  var locations = [
    //point number 1
    ['CodeBlanche', 'Crown Business Center <br />A. Hofmanweg 5a 2031BH Haarlem'] //,
  ...
  if ($('#superSizedSlider').length) {
    ...
    $.supersized({
      ...
      slides               : [           // Slideshow Images
        {image : './images/slider/super/sky.jpg', title : '<h1>Look <br />beyond <br/>the clouds</h1><a href="#news" class="btn btn-primary">read our latest news</a>', thumb : '', url : ''},
        {image : './images/slider/super/leaves.jpg', title : '<h1>Think green</h1><a href="#services" class="btn btn-primary">find out about how we work</a>', thumb : '', url : ''},
        {image : './images/slider/super/window.jpg', title : '<h1>See the big picture<br/> But focus on the details</h1><a href="#works" class="btn btn-primary">check our portfolio</a>', thumb : '', url : ''},
        {image : './images/slider/super/phone.jpg', title : '<h1>Smile</h1><a href="#contact" class="btn btn-primary">and drop us a line</a>', thumb : '', url : ''}
      ],
      // Theme Options
